...
class SamplingProcedure(Generic[Q, P]):
    ...
    def __init__(self, manifold: Manifold, scalar_parametrization: bool, T) -> None:
    ...
    def reparametrize(self, x) -> Tensor:
        raise NotImplementedError

    def kl_loss(self, x, y, s, a_func):
